(function (Prism) {
	...
	Prism.languages.swirl['closure-params'].inside.rest = Prism.languages.swirl;
	Prism.languages.swirl['attribute'].inside['string'] = Prism.languages.swirl['string'];
